...
func RegisterAIServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AIServiceServer) error {
	...
	mux.Handle("POST", pattern_AIService_Chat_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/ai.v1.AIService/Chat", runtime.WithHTTPPathPattern("/v1/ai/chat"))
		if err != nil {
...
func RegisterAIServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AIServiceClient) error {
	...
	mux.Handle("POST", pattern_AIService_Chat_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/ai.v1.AIService/Chat", runtime.WithHTTPPathPattern("/v1/ai/chat"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_AIService_Chat_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "ai", "chat"}, ""))
)
